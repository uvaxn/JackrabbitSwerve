...
public class Vars {
    ...
    public static final double AlignToAllianceWallP = 55.0;
    public static final double AlignToAllianceWallI = 5.0;
    public static final double AlignToAllianceWallD = 0.0;
    // controller stoff

    public final static SlewRateLimiter xLimiter = new SlewRateLimiter(3);
    public final static SlewRateLimiter yLimiter = new SlewRateLimiter(3);
