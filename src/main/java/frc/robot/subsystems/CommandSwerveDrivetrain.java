...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
     ...
     * This is used to find PID gains for the FieldCen xtricFacingAngle HeadingController.
        ...
        try {
            ...
            AutoBuilder.configure(
                ...
                new PPHolonomicDriveController(
                    new PIDConstants(5.5, 0, 0.2),   // Translation PID (this is in m/s, so it will correct itself 5.5m/s to the "correct" position.)
                    new PIDConstants(7.5, 0, 0)     // Rotation PID
                ),
                config,
